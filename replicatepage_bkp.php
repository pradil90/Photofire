...
$flag1 = include "availability_Alice.php";
// echo $flag1;
// $flag2 = include "availability_Rad.php";
// $flagthree = include "availability_Christ.php";
...
<!--     <div class="span4">
			<div class="box"> -->
                    ...
                    <div id="container-chart" style="min-width: 310px; max-width: 400px; height: 300px; margin: 0 auto"></div>
...
<!-- <div id="myDiv4"><h2></h2></div> -->
 ...
 <tr>
    ...
    <td><h4>Replicate 1</h4></td>    
    <td><h4>Replicate 2</h4></td>
    <td><h4>Replicate 3</h4></td>
  </tr>
<tr>
        ...
        <div class="divPanel">
            ...
            <div class="row-fluid">
                ...
                <div class="span3" id="footerArea2">
                    ...
                    <p>
                        <a href="#" title="">Photshare</a><br />
                        <span style="text-transform:none;">2 hours ago</span>
                    </p>
                    <p>
                        <a href="#" title="">Photodrop</a><br />
                        <span style="text-transform:none;">5 hours ago</span>
                    </p>
                    <p>
                        <a href="#" title="">Flickr</a><br />
