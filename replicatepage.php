...
// $result1=include('checkreplitoalice.php');
...
echo $user_utilization=$size['user_utilization'];
            ...
            if (!chart.renderer.forExport) {
                setInterval(function () {
                    var point = chart.series[0].points[0],
                        newVal,
                         inc = Math.round(("<?php echo $user_utilization ?>"));
...
<tr>
   <!--  <td> <div style="min-width: 250px; max-width: 290px; height: 200px; margin: 0 auto"></div></td> -->
    <!-- <td> <div id="container-speed" style="min-width: 250px; max-width: 290px; height: 200px; margin: 0 auto"></div></td> -->
                    ...
                    <td> <div id="container-chart1" style="min-width: 310px; max-width: 400px; height: 300px; margin: 0 auto"></div></td>
                    <td><div id="container" style="min-width: 400px; height: 300px; max-width: 600px; margin: 0 auto"></div></td>
