...
$Username=$_COOKIE["Username"];
	...
	define('GALLERY_ROOT', './project/'.$Username.'/');
	...
	define('TEXT_GALLERY_NAME', 'Photofire.net Gallery');
	define('TEXT_HOME', 'Gallery Home');
	...
	function sfpg_javascript()
	{
		...
		function showMenu()
		{
			...
			echo "menu += '<span onmouseover=\"this.className=\'sfpg_button_hover\';\" onmouseout=\"this.className=\'sfpg_button\';\" class=\"sfpg_button\" onclick=\"window.location=\'http://photofire.net/clientpage.php\'\">Home</span>';
	...
	if (isset($_GET['cmd']))
	{
		...
		if ($_GET['cmd'] == 'css')
		{
			...
			body.sfpg
			{
				background : url(https://secure.static.tumblr.com/6f27e725e987114533c96b31b4c58367/lzyknav/mxNn3n32v/tumblr_static_space-background-tumblr-categories-wallpaper.jpg);
